...
/*
la complejidad del metodo es de
2N que se expresaria como O(n) por lo cual lo cual
lo hace muy complejo para un crecimiento
a gran escala, ya que entre mas datos su complejidad
haria mas problematica su implementacion
*/
